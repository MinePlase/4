...
print("Последняя буква вашего слова:", message[length-1])
print("Первые 3 буквы: ", message[0:3])
print("Последние 3 буквы: ", message[length-3:])
...
chiper_four = message[length-1] + message[1:length-1] + message[0]
...
if length % 2 == 0:
    ...
    half_two = chiper_three[half_length:length]
else:
...
decoder_four = chiper_four[length-1] + chiper_four[1:length-1] + chiper_four[0]
print("Расшифровка 4: ", decoder_four)
decoder_five = message[:half_length] + message[half_length:]
